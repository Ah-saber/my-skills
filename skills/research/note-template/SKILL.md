---
name: note-template
description: 为不同类型的笔记创建标准模板，包括论文笔记、概念笔记、项目笔记、索引笔记、综述笔记等。**必须使用此技能**当用户说"创建笔记模板"、"笔记模板"、"新笔记模板"、"创建模板"、"笔记格式模板"、"创建综述"、"综述模板"，或需要创建特定类型的新笔记、为笔记库建立标准格式时。
version: 1.1.0
---
...
6. 综述笔记（对一批论文进行系统性梳理，**叙事性结构 + 双链引用**）
```
...
| 综述笔记 | 对一批论文进行系统性梳理，叙事性综述 | [综述笔记参考.md](./ref/综述笔记参考.md) |
...
---
title: "笔记标题"
type: [paper|concept|project|daily|index|survey]
tags: [标签1, 标签2]
date: 2024-01-15
...
[[笔记名|方法名]]（作者 et al., 年份）提出了[核心贡献]。[[另一笔记名|另一方法]]（作者 et al., 年份）进一步[延伸/改进]。这些工作共同表明，**[关键洞察]**。
...
| :---: | :--- | :--- | :---: | :--------: | :--- |
| 1 | [[笔记名\|方法简称]] | 作者 et al. | 年份 | `KEY` | 说明 |
```

**综述内容维度**：方法对比、前提假设、理论依据、抽象层级、框架思路、局限性、共同假设、互补思路

**信息来源优先级**：(1) MyPoint 段落（用户思考），(2) 笔记正文（必须读实际内容），(3) 标签和元数据
