...
This is the my-skill collection — a set of Claude Code skills implementing the Iteration Workflow Protocol.
...
See `doc/iteration-workflow-protocol.md` for the full protocol design.
